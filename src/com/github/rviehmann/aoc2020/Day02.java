...
public class Day02 {
    ...
    public static class PasswordEntryPuzzle1 {
        ...
        public PasswordEntryPuzzle1(int min, int max, char character, String password) {
            this.min = min;
            this.max = max;
        ...
        public static PasswordEntryPuzzle1 fromString(String entry) {
    ...
    public static class PasswordEntryPuzzle2 {
        ...
        public PasswordEntryPuzzle2(int pos1, int pos2, char character, String password) {
            this.pos1 = pos1;
            this.pos2 = pos2;
            this.character = character;
            this.password = password;
        ...
        public static PasswordEntryPuzzle2 fromString(String entry) {
            Matcher matcher = PATTERN.matcher(entry);
            if (!matcher.matches()) {
                throw new IllegalArgumentException("Input does not match pattern.");
            }
        ...
        public boolean isValid() {
            char character1 = password.charAt(pos1 - 1);
            char character2 = password.charAt(pos2 - 1);
            return (character1 == character ? 1 : 0)
                    + (character2 == character ? 1 : 0)
                    == 1;
        }
    }
