...
public class Day18 {
    ...
    private static final String EXAMPLE1 = "1 + 2 * 3 + 4 * 5 + 6";
    private static final String EXAMPLE2 = "1 + (2 * 3) + (4 * (5 + 6))";
    private static final String EXAMPLE3 = "2 * 3 + (4 * 5)";
    private static final String EXAMPLE4 = "5 + (8 * 3 + 9 + 3 * 4 * 3)";
    private static final String EXAMPLE5 = "5 * 9 * (7 * 3 * 3 + 9 * 3 + (8 + 6 * 4))";
    private static final String EXAMPLE6 = "((2 + 4 * 9) * (6 + 9 * 8 + 6) + 6) + 2 + 4 * 2";

    // From: https://adventofcode.com/2020/day/18/input
    ...
    private static long calculatePart1(String input) throws com.github.rviehmann.aoc2020.Day18Part1.ParseException {
        InputStream stream = new ByteArrayInputStream(input.getBytes(StandardCharsets.UTF_8));
        com.github.rviehmann.aoc2020.Day18Part1.Calculate calculate = new com.github.rviehmann.aoc2020.Day18Part1.Calculate(stream);
        return calculate.Expression();
    }

    private static long calculatePart2(String input) throws com.github.rviehmann.aoc2020.Day18Part2.ParseException {
        InputStream stream = new ByteArrayInputStream(input.getBytes(StandardCharsets.UTF_8));
        com.github.rviehmann.aoc2020.Day18Part2.Calculate calculate = new com.github.rviehmann.aoc2020.Day18Part2.Calculate(stream);
        return calculate.Expression();
    }

    public static void testWithExamplesForPuzzle1() {
        System.out.println("### Day 18: Examples for puzzle 1 ###");
        try {
            System.out.println("This should yield 71: " + calculatePart1(EXAMPLE1));
            System.out.println("This should yield 51: " + calculatePart1(EXAMPLE2));
            System.out.println("This should yield 26: " + calculatePart1(EXAMPLE3));
            System.out.println("This should yield 437: " + calculatePart1(EXAMPLE4));
            System.out.println("This should yield 12240: " + calculatePart1(EXAMPLE5));
            System.out.println("This should yield 13632: " + calculatePart1(EXAMPLE6));
        } catch (com.github.rviehmann.aoc2020.Day18Part1.ParseException e) {
            e.printStackTrace();
        }
    }

    public static void testWithExamplesForPuzzle2() {
        System.out.println("### Day 18: Examples for puzzle 2 ###");
        try {
            System.out.println("This should yield 231: " + calculatePart2(EXAMPLE1));
            System.out.println("This should yield 51: " + calculatePart2(EXAMPLE2));
            System.out.println("This should yield 46: " + calculatePart2(EXAMPLE3));
            System.out.println("This should yield 1445: " + calculatePart2(EXAMPLE4));
            System.out.println("This should yield 669060: " + calculatePart2(EXAMPLE5));
            System.out.println("This should yield 23340: " + calculatePart2(EXAMPLE6));
        } catch (com.github.rviehmann.aoc2020.Day18Part2.ParseException e) {
            e.printStackTrace();
        }
    }
    ...
    public static long doPuzzle1() {
        ...
        for (String line : INPUT_AS_LINE_ARRAY) {
            try {
                long calculated = calculatePart1(line);
                accu += calculated;
            } catch (com.github.rviehmann.aoc2020.Day18Part1.ParseException e) {
                e.printStackTrace();
            }
    ...
    public static long doPuzzle2() {
        ...
        for (String line : INPUT_AS_LINE_ARRAY) {
            try {
                long calculated = calculatePart2(line);
                accu += calculated;
            } catch (com.github.rviehmann.aoc2020.Day18Part2.ParseException e) {
                e.printStackTrace();
            }
